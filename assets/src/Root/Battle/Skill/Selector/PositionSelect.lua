...
function PositionSelect:solution2()
    return self.mSkill.mMonster:getChild("ActionSprite"):getOrginPosition()
end

-- 3已方当前位置
function PositionSelect:solution3()
    return cc.p(self.mSkill.mMonster:getChild("ActionSprite"):getPosition())
end

-- 4目标当前位置
function PositionSelect:solution4()
    return cc.p(self.mSkill.mTarget:getChild("ActionSprite"):getPosition())
end

-- 已方阵型中心
function PositionSelect:solution5()
    local group = self.mSkill.mMonster:getChild("GroupID")
